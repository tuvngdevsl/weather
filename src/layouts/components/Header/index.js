                    ...
                    <div>
                        ...
                        <div className={cx('sub-header')}>
                            <div className={cx('location-temp')}>
                                <img src={`http://openweathermap.org/img/w/${currentWeatherLocation?.weather[0].icon}.png`} alt='icon' className={cx('img-weather')}></img>
                                <span>   {Math.round(kelvinToCelsius(currentWeatherLocation?.main.temp))}° {currentWeatherLocation.name}, {currentWeatherLocation.sys.country}</span>
                            </div>
